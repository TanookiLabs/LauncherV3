...
public class SettingsFactory {
    public static TechnicSettings buildSettingsObject(String runningDir, boolean isMover) {
        ...
        File installedSettingsDir = OperatingSystem.getOperatingSystem().getUserDirectoryForApp("littlebits-bitcraft");
    ...
    private static File getPortableSettingsDir(String runningDir, boolean isMover) {
        ...
        if (isMover)
            ...
            return new File(runningFolder,"littlebits-bitcraft");
    }
}
